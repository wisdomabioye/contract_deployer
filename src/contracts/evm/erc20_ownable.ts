...
export const description = "Standard ERC20 token, burnable and the deployer as the owner.";
...
export interface ContractProps  {
    name: string;
    ticker: string;
    supply: number; // unit256
    decimals: number; // uint21
}
...
export const contractFields = [
    ...
    {name: "supply", type: "text", label: "Token supply e.g 1000000", placeholder: "Enter token supply", solType: "uint256"},
 ];
