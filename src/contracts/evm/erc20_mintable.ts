...
export const description = "Standard ERC20 token, mintable, burnable and the deployer as the owner.";
...
export const contractFields = [
    ...
    {name: "ticker", type: "text", label: "Token ticker e.g CKP", placeholder: "Enter token ticker", solType: "string"},
 ...
 */
 export function contractCode (contractName: string): string {
    ...
    */
     ...
     */
    contract ${contractName} is IERC20, Ownable {
...
/**
 * @description unused_contractCode
 * TODO: In the future, we can use this to generate bytecode using solc-js and
 * provide the option to the user to inject variables into the contract code.
 * This is the code that will be used to deploy the contract
 * Each parameter will be collected from the front end and pass to the `contractCode`
 * 
 */